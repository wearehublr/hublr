  ...
  return (
    <main className="mx-auto w-full max-w-4xl flex-1 px-4 py-12 sm:px-6 sm:py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <h2 className="text-xl font-semibold">Opportunities Tracker</h2>
          <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
            See which internships, off-cycle, grad schemes and more are live
            right now, and their deadlines, across the UK, EU, and US.
          </p>
        </Link>
        ...
        <Link
          ...
          className="rounded-lg border border-neutral-200 dark:border-neutral-800 p-6 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors"
        >
          <h2 className="text-xl font-semibold">Event Tracker</h2>
          <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
        ...
        >
          ...
          <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
            Guides and newsletter resources to help you walk into interviews
            prepared.
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
            Track where you&apos;ve applied, what stage you&apos;re at, and
            upcoming deadlines.
          </p>
        </Link>
        ...
        <Link
          href="/documents"
          className="rounded-lg border border-neutral-200 dark:border-neutral-800 p-6 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors sm:col-span-2"
        >
          <h2 className="text-xl font-semibold">Documents</h2>
          <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
            Store and manage your CVs and cover letters, and attach the
            right version to each application.
          </p>
        </Link>
      </div>
    </main>
