...
import { getAllInterviewResources } from "@/lib/interview-resources";
...
export default async function AdminInterviewPrepPage() {
  const supabase = await createClient();
  const resources = await getAllInterviewResources(supabase);
